...
NameFactory::NameFactory(): delimiter_("!") {
}

NameFactory::NameFactory(const std::string &delimiter): delimiter_(delimiter) {
}
...
std::string NameFactory::GetUniqueName(const std::string &base_name) {
    ...
    return base_name + delimiter_ + std::to_string(cnt);
}
